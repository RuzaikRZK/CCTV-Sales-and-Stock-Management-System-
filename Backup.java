...
public class Backup {
    ...
    public boolean Backup() {
        ...
        try {
            ...
            //String password = "123";
            String database = "kontrinex_stockmanagement";
            int complete;

            path = "F:\\mysqldump.exe "+"-u" + username +" --database " + database + " -r " + path;
    ...
    public boolean Restore(JTextField jTextField1) throws IOException, InterruptedException {
        restore = false;
        String database = "kontrinex_stockmanagement";//database name
        ...
        String[] executeCmd = new String[]{"F:\\mysql.exe", "--user=" + username, "-e", " source " + filepath};
